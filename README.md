...
- **Bob's Health Bar** — Bob's health is directly tied to your task completion rate. Keep it green by finishing what you start.
...
- **Persistent State** — Your tasks and Bob's health are saved locally so nothing is lost between sessions.
...
When you open the app, Bob appears as a floating widget in the bottom-right corner of your screen. The main window lets you manage your tasks across daily, weekly, and monthly checklists. Each time you complete a task, Bob's health recalculates and his expression updates in real time.

Bob's health is calculated as the percentage of tasks completed across all active lists. At over 60% he's happy, between 30–60% he's neutral, and below 30% he's not doing well. Keep those checkmarks coming to keep Bob smiling.
